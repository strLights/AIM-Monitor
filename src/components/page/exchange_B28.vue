        ...
        <div class="table">
            ...
            <el-row class="wrapper">
                ...
                <el-col class="table-main">
                    <h2 style="font-family:monospace; font-size: 20px;">交换机</h2>
                    ...
                    <el-autocomplete icon="search" class="inline-input" v-model="state1" :fetch-suggestions="querySearch"
                        ...
                        style="width: 550px; margin: 15px 0;"></el-autocomplete>
                    <el-table v-loading.body="loading" :data="tableData" style="width:100%; background-color: #14171c;"
    ...
    data() {
        return {
            tableData: [
                {
                    ip: '172.40.1.174',
                    useTo: 'Cisco 400G、大模型',
                    status: 'UP',
                    model: 'CISCO C9332D-GX2B',
                    system: ' CISCO ',
                    kernel: '',
                    cpuModel: '',
                    cpuCores: '',
